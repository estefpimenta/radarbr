...
function AlertCard({alerta, cidade}) {
        ...
        <div className="alert-card-container">
            ...
            <div className='alert-card-content'>
                <div className="alert-card-content-text">
                    <p className='alert-card-description'><span className='alert-card-label'>Tipo:</span> {alerta.descricao}</p>
                    <p className='alert-card-description'><span className='alert-card-label'>Válido até:</span> {alerta.fim}</p>
